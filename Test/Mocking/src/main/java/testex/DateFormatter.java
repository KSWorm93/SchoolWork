 ...
 * @param time Date time is sent as param. so make better testable code.
...
//  }
  ...
  public static void main(String[] args) throws JokeException  {
    ...
    System.out.println(new DateFormatter().getFormattedDate(new Date(), "Europe/Kiev"));
    
    System.out.println(new DateFormatter().getFormattedDate(new Date(), "ImNotLegal"));
